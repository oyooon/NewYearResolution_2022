# NewYearResolution
Network Programming Project (University Of Suwon)

### ✅ 프로젝트 소개

신년 목표 세우기 New Year Resolution 웹 서비스

2021년 크리스마스 전, 사람들에게 자신의 트리를 공유할 수 있게 하는 ‘내 트리를 꾸며줘!’ 웹 서비스가 있었다. 트리로 갈 수 있는 링크를 타고 들어가면 트리 주인을 제외한 다른 사람들이 메시지를 장식할 수 있도록 하고, 트리의 주인이 크리스마스 당일에 내용을 확인할 수 있는 서비스이다. 많은 사람들에게 좋은 경험을 주었고 올해도 시행될 산타파이브의 크리스마스 트리를 모티브로 삼아 웹 서비스를 개발한다.
